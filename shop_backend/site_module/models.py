...
class SiteSetting(models.Model):
    ...
    site_logo = models.ImageField(verbose_name='لوگوی سایت', upload_to='images/site-setting')
    title = models.CharField(verbose_name='عنوان درباره ما', max_length=100, default='درباره ما')
    text = models.TextField(verbose_name='متن درباره ما صفحه اصلی')
    imageurl = models.ImageField(verbose_name='عکس درباره ما صفحه اصلی', upload_to='images/site-setting')
...
class TrustSymbols(models.Model):
    image = models.ImageField(verbose_name='عکس نماد اعتماد', upload_to='images/trust-symbol')
