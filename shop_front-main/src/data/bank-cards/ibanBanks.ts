export interface IBANBank {
    ...
    process?: (iban: string) => { normal: string; formatted: string }
}

export const ibanBanks: IBANBank[] = [
    {
...
export const ibanBanksHash: Record<string, IBANBank> = {}
ibanBanks.forEach(b => ibanBanksHash[b.code] = b)